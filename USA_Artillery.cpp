...
void USA_Artillery::set_name(char * _name)
{
	strcpy(name, _name);
}

void USA_Artillery::set_cost(int _cost)
{
	cost = _cost;
}

void USA_Artillery::set_storage_cost(int _storage_cost)
{
	storage_cost = _storage_cost;
}

void USA_Artillery::set_occupied_space(int _occupied_space)
{
	occupied_space = _occupied_space;
}

void USA_Artillery::set_firepower(int _firepower)
{
	firepower = _firepower;
}

char * USA_Artillery::get_name()
{
	return name;
}

int USA_Artillery::get_cost()
{
	return cost;
}

int USA_Artillery::get_storage_cost()
{
	return storage_cost;
}

int USA_Artillery::get_occupied_space()
{
	return occupied_space;
}

int USA_Artillery::get_firepower()
{
	return firepower;
}

int USA_Artillery::get_number_in_the_army()
{
	return number_in_the_army;
}

void USA_Artillery::set_number_in_the_army(int _number_in_the_army)
{
	number_in_the_army = _number_in_the_army;
}

void USA_Artillery::set()
{
	Exception ex;
	string text;
